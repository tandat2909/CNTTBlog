...
@foreach($post->CommentCollection as $comment)
    <div class="forum-comment">
        <div class="forum-post-top">
            <a class="author-avatar" href="#">
                <img src="{{$comment->User->avatar}}" alt="author avatar">
            </a>
            <div class="forum-post-author">
                ...
                <div class="forum-author-meta">
                    ...
                    <div class="author-badge">
                        ...
                        <a href="">{{ $comment->updated_at->diffForHumans()}}</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="comment-content">
            <p>{{ $comment->content}}</p>
            @foreach($comment->CommentChild as $commentChild)
                <div class="flex-grow-1 flex-shrink-1 forum-commen-child">
                    <div class="forum-post-top">
                        <a class="author-avatar" href="#">
                            <img src="{{$commentChild->User->avatar}}" alt="author avatar">
                        </a>
                        <div class="forum-post-author">
                            <a class="author-name" href="#">{{$commentChild->User->name}}</a>
                            <div class="forum-author-meta">
                                <div class="author-badge">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                         xmlns:xlink="http://www.w3.org/1999/xlink" width="16px"
                                ...
                                <div class="author-badge">
                                    <i class="icon_calendar"></i>
                                    <a href="">{{ $commentChild->updated_at->diffForHumans()}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    if(typeof addEventButtonComment === "function"){
